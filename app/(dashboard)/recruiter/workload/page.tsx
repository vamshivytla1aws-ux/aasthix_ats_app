...
"/api/recruiter/workload",
 ...
 align:"right",
 cell: (r) => <span className="font-semibold text-[var(--ats-text)]">{r.assigned_jds}</span>,
 },
 {
 id:"active",
 header:"Active",
 ...
 cell: (r) =>
 r.last_activity_at ? (
 <span className="text-xs text-[var(--ats-text-muted)]">{formatDate(r.last_activity_at)}</span>
 ) : (
 ...
 <span>
 <span className="font-semibold text-[var(--ats-text)]">{recruiters.length}</span>
 <span className="text-[var(--ats-text-muted)]"> recruiter{recruiters.length !== 1 ?"s" :""}</span>
 </span>
 <span>
 <span className="font-semibold text-emerald-700 dark:text-emerald-300">{totalActive}</span>
 <span className="text-[var(--ats-text-muted)]"> active JDs</span>
 </span>
 <span>
 <span className="font-semibold text-[var(--ats-text)]">{totalApps}</span>
 <span className="text-[var(--ats-text-muted)]"> applications</span>
 </span>
 </span>
 )
 }
 ...
 emptyMessage={
 <div>
 <div className="font-semibold text-[var(--ats-text)]">No recruiter data</div>
