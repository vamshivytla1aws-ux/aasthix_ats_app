...
export default function ProductRoadmapPage() {
 ...
 <div className="flex flex-col gap-4 rounded-2xl border border-[var(--ats-border)] bg-gradient-to-br from-white via-slate-50/50 to-blue-50/30 p-5 shadow-sm sm:flex-row sm:items-start sm:justify-between sm:p-6">
 <div className="min-w-0">
 <p className="text-xs font-bold uppercase tracking-wider text-blue-700/90">Product</p>
 <h1 className="mt-1 text-2xl font-bold tracking-tight text-[var(--ats-text)]">Enterprise roadmap</h1>
 <p className="mt-2 max-w-2xl text-sm text-[var(--ats-text-muted)]">
