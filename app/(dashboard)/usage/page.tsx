...
export default function AiUsagePage() {
  ...
  return (
    <AccessGate permissionKey="dashboard.view">
      ...
      >
        <div className="mb-4 flex flex-wrap items-center gap-1 rounded-xl border border-slate-200 bg-white p-1 shadow-sm dark:border-slate-700 dark:bg-slate-900">
          {[
...
function DateFilter({
  ...
  return (
    <div className="relative">
      ...
      {open ? (
        <div className="absolute right-0 z-40 mt-2 w-64 rounded-xl border border-slate-200 bg-white p-2 shadow-lg dark:border-slate-700 dark:bg-slate-900">
