...
describe("AI interview security and lifecycle",()=>{
 ...
 it("accepts supported integrity events only",()=>{expect(INTEGRITY_EVENT_TYPES.has("TAB_HIDDEN")).toBe(true);expect(INTEGRITY_EVENT_TYPES.has("BACKGROUND_APP_DETECTED")).toBe(false);});
